# SchoolHelper: Штуки, которых нет в МЭШ штатно

Дополнительные функции для МЭШ:

**Экспорт расписания уроков** (-7/+14 дней) в отдельный файл (для каждого ребенка) в формате [iCal](https://ru.wikipedia.org/wiki/ICal) в хранилище Яндекс.Облака.
